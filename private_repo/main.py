...
API_KEY = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..lmETmddqccKDBvgiTz9_bg_2TcYrlHLpFxKNO3gHAkC0v1M7WQqMPTh-DEjS2HigdhOqHs15h_LyjXBhyXGc8A'
player_tag = '#Y0828VUYP'
clan_tag = '#20PVJ2JU2'
...
# Get Single Clan
sinfleClan_df = apiHelpers.getSingleClan(headers, clan_tag, overwrite_pkl=1)

# Get Single Clan's Members
singleClansMembers_df = apiHelpers.getSingleClanMembers(headers, clan_tag, overwrite_pkl=1)
